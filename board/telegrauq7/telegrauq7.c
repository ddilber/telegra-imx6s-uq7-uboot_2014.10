...
static const iomux_v3_cfg_t uq7_lcd_pads[] = {
...
static void enable_uq7_fwadapt_7wvga(struct display_info_t const *dev)
{
    imx_iomux_v3_setup_multiple_pads(
        uq7_lcd_pads,
        ARRAY_SIZE(uq7_lcd_pads));
...
struct display_info_t const displays[] = {{
    ...
    .pixfmt	= IPU_PIX_FMT_RGB666,
    .detect	= detect_i2c,
    .enable	= enable_uq7_fwadapt_7wvga,
    .mode	= {
        .name           = "FWBADAPT-LCD-F07A-0102",
        .refresh        = 60,
        .xres           = 800,
